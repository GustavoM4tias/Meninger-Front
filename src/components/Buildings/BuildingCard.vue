...
// console.log("Recebido no BuildingCard:", props.building);
        ...
        <div class="content flex flex-col justify-between h-72 z-10 relative p-4 text-white">
            <div class="titulo">
                <div class="flex justify-between">
                    <h1 class="text-xl truncate filter md:text-xl font-semibold drop-shadow-md w-4/6">{{ props.building.nome }}</h1>
                ...
                <ul class="flex flex-wrap">
                    <li class="hover:bg-gray-100 hover:text-gray-800 text-gray-200 border border-gray-300 cursor-pointer filter drop-shadow duration-300 shadow px-2 py- m-1 rounded-lg">{{ props.building.segmento[0].nome }}</li>
                    <li class="hover:bg-gray-100 hover:text-gray-800 text-gray-200 border border-gray-300 cursor-pointer filter drop-shadow duration-300 shadow px-2 py- m-1 rounded-lg">{{ props.building.situacao_obra[0].nome }}</li>
                    <li class="hover:bg-gray-100 hover:text-gray-800 text-gray-200 border border-gray-300 cursor-pointer filter drop-shadow duration-300 shadow px-2 py- m-1 rounded-lg">{{ props.building.tipo_empreendimento[0].nome }}</li>
                </ul>
            </div>
