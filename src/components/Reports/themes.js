...
export const REPORT_THEMES = {
  ...
  ocean: {
    ...
    swatch: '#0d9488',
    series:     ['#0d9488', '#0369a1', '#7c3aed', '#e11d48', '#ca8a04', '#4d7c0f', '#64748b'],
    seriesDark: ['#2dd4bf', '#38bdf8', '#a78bfa', '#fb7185', '#fde047', '#a3e635', '#94a3b8'],
    vars: {
      '--rp-font-display': "'Inter', system-ui, sans-serif",
      '--rp-font-body': "'Inter', system-ui, sans-serif",
  ...
  sunset: {
    ...
    swatch: '#f43f5e',
    series:     ['#e11d48', '#ea580c', '#c026d3', '#ca8a04', '#0d9488', '#4f46e5', '#64748b'],
    seriesDark: ['#fb7185', '#fb923c', '#e879f9', '#fde047', '#2dd4bf', '#818cf8', '#94a3b8'],
    vars: {
      '--rp-font-display': "'Fraunces', Georgia, serif",
      '--rp-font-body': "'Inter', system-ui, sans-serif",
      '--rp-accent': '225 29 72',
  ...
  berry: {
    ...
    swatch: '#c026d3',
    series:     ['#c026d3', '#7c3aed', '#0891b2', '#e11d48', '#65a30d', '#d97706', '#64748b'],
    seriesDark: ['#e879f9', '#a78bfa', '#22d3ee', '#fb7185', '#a3e635', '#fbbf24', '#94a3b8'],
    vars: {
      '--rp-font-display': "'Inter', system-ui, sans-serif",
      '--rp-font-body': "'Inter', system-ui, sans-serif",
  ...
  citrus: {
    ...
    swatch: '#65a30d',
    series:     ['#65a30d', '#ea580c', '#0891b2', '#c026d3', '#ca8a04', '#0d9488', '#64748b'],
    seriesDark: ['#a3e635', '#fb923c', '#22d3ee', '#e879f9', '#fde047', '#2dd4bf', '#94a3b8'],
    vars: {
      '--rp-font-display': "'Fraunces', Georgia, serif",
      '--rp-font-body': "'Inter', system-ui, sans-serif",
