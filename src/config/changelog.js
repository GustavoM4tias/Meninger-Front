...
export const releases = [
  {
    ...
    categories: ['frontend', 'backend'],
    features: [
      { id: 1, title: 'Mural de atualizações', description: 'Este quadro: o que mudou na plataforma, uma vez a cada publicação. O histórico completo fica em Documentação.', link: '/docs' },
      { id: 2, title: 'Aviso que aparece sozinho', description: 'O que você não leu aparece no canto ao entrar, some sozinho e leva à tela do assunto. O mouse em cima segura a contagem.', link: '/notifications' },
      { id: 3, title: 'Cada aviso com a cara do seu assunto', description: 'Checklist, leads, Academy, comunicado e reunião ganham ícone e cor próprios. Antes, 42 dos 47 tipos eram um "Aviso" cinza.' },
    ],
    improvements: [
      { id: 1, category: 'Caixa de notificações', description: 'Agrupada por dia, com Hoje e Ontem no topo.' },
      { id: 2, category: 'Sino', description: 'O painel cabe na tela do celular, fecha ao abrir um aviso e se atualiza sozinho.' },
      { id: 3, category: 'Avisos do sistema', description: 'Deixaram de cobrir a barra de navegação.' },
    ],
    fixes: [
      { id: 1, description: 'A caixa mostrava as mensagens mais antigas e nunca chegava às recentes: com 327 avisos, ficava parada em maio.' },
      { id: 2, description: 'O aviso de reunião começando não podia ser configurado, por uma linha trocada no catálogo.' },
      { id: 3, description: 'Aviso sem tela de destino parecia clicável e não levava a lugar nenhum.' },
    ],
    breakingChanges: [
      { id: 1, description: 'A caixa não empurra mais as não lidas para o topo: a ordem é sempre da mais recente para a mais antiga. Para ver só o pendente, use a aba Não lidas.' },
    ],
    knownIssues: [],
  },
  {
    ...
    categories: ['frontend', 'backend'],
    features: [
      { id: 1, title: 'Outlook dentro do Office', description: 'A caixa de e-mail com pastas, organização e envio, sem trocar de sistema.', link: '/microsoft/outlook' },
      { id: 2, title: 'Teams no Office', description: 'Conversas, quem está disponível agora e a sala real da reunião.', link: '/microsoft/teams' },
      { id: 3, title: 'Ata pronta sozinha', description: 'Terminou a reunião gravada, a transcrição vira ata com o minuto, quem disse e o que ficou em aberto. Quem participou é avisado.' },
      { id: 4, title: 'Arquivos da nuvem', description: 'Busca em todo o SharePoint e no OneDrive, com prévia de planilha lida da nuvem, sem baixar.' },
      { id: 5, title: 'A Eme enxerga a sua tela', description: 'Ela sabe onde você está, e o Ctrl+clique aponta o assunto da pergunta.' },
    ],
    improvements: [
      { id: 1, category: 'Agendamento', description: 'A disponibilidade das pessoas aparece na hora de marcar a reunião.' },
      { id: 2, category: 'Permissões', description: 'As autorizações do Azure foram consolidadas num lugar só.' },
    ],
    fixes: [
      { id: 1, description: 'Reunião editada perdia o link e a descrição.' },
      { id: 2, description: 'O aviso de permissão da Microsoft aparecia para qualquer pessoa, sem nada que ela pudesse fazer: quem concede é o administrador do sistema.' },
    ],
    breakingChanges: [],
    knownIssues: [],
  },
  {
    ...
    description: 'Cobrança do ato aceita cartão, e o Office inteiro passa a falar a mesma língua visual.',
    type: 'minor',
    categories: ['frontend', 'backend'],
    features: [
      { id: 1, title: 'Ato: boleto e cartão na mesma tela', description: 'A forma sai do parcelamento da série (1 vez é boleto, de 2 a 12 é link de cartão), com envio ao cliente e histórico unificado.', link: '/financeiro/cobranca/ato' },
      { id: 2, title: 'Como usar em 22 telas', description: 'Cada tela explica para que serve e o que fazer nela, sem manual à parte.' },
    ],
    improvements: [
      { id: 1, category: 'Confirmações', description: 'A caixa cinza do navegador saiu do sistema: a pergunta diz a consequência antes de você decidir.' },
      { id: 2, category: 'Leitura de relatório', description: 'As 18 paletas foram corrigidas para daltonismo, e nenhum texto fica abaixo de 11px.' },
      { id: 3, category: 'Carregamento', description: 'A tela mostra o formato do que está por vir, em vez de uma bolinha girando.' },
    ],
    fixes: [
      { id: 1, description: 'Cartão clicável não era alcançável pelo teclado.' },
      { id: 2, description: 'Desempenho diário das campanhas tinha dois eixos e enganava a leitura.' },
    ],
    breakingChanges: [],
    knownIssues: [],
  },
  {
    ...
    description: 'A alçada passa a valer por ação dentro da tela, e não só pelo acesso a ela.',
    type: 'minor',
    categories: ['frontend', 'backend'],
    features: [
      { id: 1, title: 'Permissão por ação', description: 'Dar a tela a alguém deixou de dar tudo o que há nela: cada ação é liberada em separado.', link: '/settings/permissions' },
      { id: 2, title: 'Situação do repasse na reserva', description: 'A reserva mostra em que etapa o repasse está e leva ao registro no CV.', link: '/comercial/reservas' },
    ],
    improvements: [
      { id: 1, category: 'Alçadas', description: 'A lista mostra cargo, departamento e organização externa.' },
      { id: 2, category: 'Pré-cadastros', description: 'A origem do lead passa a usar a regra de captação do próprio Office.' },
    ],
    fixes: [
      { id: 1, description: 'Usuário externo e perfil inativo sumiam da lista de alçadas.' },
      { id: 2, description: 'Boleto do ato: reserva cancelada aparecia como erro, o indicador contava tentativa em vez de reserva, e pagamento sem o rótulo "liquidado" não era reconhecido.' },
      { id: 3, description: 'Cancelar uma reserva baixava o boleto na hora, antes de a baixa ser confirmada.' },
    ],
    breakingChanges: [
      { id: 1, description: 'O módulo de Aprovações foi removido do Office.' },
    ],
    knownIssues: [],
  },
  {
