...
export const releases = [
  {
    ...
    description: 'As notificações passam a chegar até você em vez de esperarem ser procuradas, e o sistema ganha um mural que apresenta cada novidade da plataforma na primeira vez que você entra depois da publicação.',
    type: 'minor',
    categories: ['frontend', 'backend'],
    features: [
      { id: 1, title: 'Mural de atualizações', description: 'Ao abrir o Office depois de uma publicação, um quadro apresenta o que mudou: o que passou a existir, o que melhorou, o que foi corrigido e, principalmente, as regras que mudaram. Aparece uma vez e vale para todos os seus aparelhos: leu no computador, não volta no celular. O histórico completo continua em Documentação, para consultar quando quiser.', link: '/docs' },
      { id: 2, title: 'Aviso que aparece sozinho', description: 'Ao entrar no sistema e ao voltar para a tela inicial, os avisos que você ainda não leu aparecem no canto da tela, um a cada dois segundos, e somem sozinhos. Passar o mouse sobre qualquer um deles segura a contagem de todos, para dar tempo de ler sem perder os outros. Clicar leva direto à tela do assunto. Cada aviso aparece uma vez só: quem já foi mostrado não volta a interromper.', link: '/notifications' },
      { id: 3, title: 'Cada aviso com a cara do seu assunto', description: 'Checklist, plano de eventos, leads, Academy, comunicado e reunião passam a ter ícone, cor e rótulo próprios no sino e na caixa de entrada. Antes só evento e suporte tinham identidade: todo o resto aparecia como "Aviso" cinza, e a lista inteira parecia a mesma coisa repetida. O aviso também diz quando leva a uma tela, então dá para saber antes de clicar.' },
    ],
    improvements: [
      { id: 1, category: 'Caixa de notificações', description: 'A lista passa a ser agrupada por dia, com Hoje e Ontem no topo, e o botão de remover fica visível no celular, onde não existe passar o mouse.' },
      { id: 2, category: 'Sino de notificações', description: 'O painel do sino era mais largo que a tela de um celular e nascia cortado; agora se ajusta à tela. Abrir um aviso fecha o painel, em vez de deixá-lo por cima da tela de destino, e a lista se atualiza sozinha enquanto o sistema está aberto, e não só o número do sino.' },
      { id: 3, category: 'Avisos do sistema', description: 'Os avisos no canto da tela deixaram de cobrir a barra de navegação e passaram a entrar e sair deslizando, em vez do salto anterior.' },
    ],
    fixes: [
      { id: 1, description: 'A caixa de notificações mostrava as mensagens mais ANTIGAS na primeira página e nunca chegava às recentes: com 327 avisos, a tela ficava parada em maio. Agora começa sempre pelo que chegou por último.' },
      { id: 2, description: 'O aviso de reunião começando estava sem nome e sem grupo na tela de preferências, por uma linha trocada no catálogo, e não podia ser configurado. É o tipo de aviso que mais dispara hoje.' },
      { id: 3, description: 'Aviso sem tela de destino parecia clicável e o clique não levava a lugar nenhum.' },
    ],
    breakingChanges: [
      { id: 1, description: 'A caixa de notificações deixou de empurrar as não lidas para o topo: a ordem agora é a cronológica, da mais recente para a mais antiga, em qualquer situação. Para ver só o que está pendente, use a aba Não lidas.' },
    ],
    knownIssues: [],
  },
  {
