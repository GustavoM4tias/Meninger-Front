...
export const officeMap = {
    ...
    c: [
        {
            t: '8 módulos em produção',
            s: 'Cerca de 50 telas, todas em uso real. Comercial e Marketing produzem as informações que só existem no Office',
            acc: MAP_ACCENTS.modulos,
            c: [
                {
                    t: 'Comercial', s: 'O carro-chefe', c: [
                        { t: 'Faturamento', k: 'só no Office', s: 'Relatório de vendas: venda consolidada por empreendimento e empresa, VGV pela regra de cada um, mês fechado auditável' },
                        { t: 'Projeção', k: 'só no Office', s: 'Relatório gerencial de metas: ticket médio, VGV projetado, viabilidade e estoque atual e futuro' },
                        { t: 'Vendas × Metas', k: 'só no Office', s: 'Realizado contra projetado na mesma régua, meta e venda no mesmo motor' },
                        { t: 'Atendimento e situação', k: 'só no Office', s: 'Leads, etapa da reserva, repasse e pré-cadastro em um painel descomplicado' },
                        { t: 'Fichas Comerciais', s: 'Condições comerciais mensais por empreendimento' },
                        { t: 'Empreendimentos', s: 'Cadastro, etapas e unidades' },
                        { t: 'Imobiliárias', s: 'Cadastro por link público, sem digitação interna' },
                        { t: 'Correspondentes', s: 'Equipes e cadastros, importação por colagem' },
                        { t: 'Cancelamento de Reservas', s: 'Unidade volta ao estoque com segurança, contrato excluído no ERP' },
                    ],
                },
                {
                    t: 'Marketing', s: 'Segue o Comercial na produção do dado exclusivo', c: [
                        { t: 'Central Meta', k: 'só no Office', s: 'Captação, campanhas, vínculos e formulários: cada lead ligado à campanha e ao investimento, com custo por lead real' },
                        { t: 'Viabilidade', s: 'Teto, realizado e projetado de marketing por empreendimento' },
                        { t: 'Stand de Vendas', s: 'Modelos e stands reais com custo ao vivo do Sienge' },
                        { t: 'Eventos e Plano de Eventos', k: 'só no Office', s: 'Agenda, itens, custo estimado, aprovação item a item com corte de valor e mês consolidado' },
                    ],
                },
                {
                    t: 'Financeiro', c: [
                        { t: 'Títulos e Custos', s: 'Leitura ao vivo da cópia do ERP, custo em regime de caixa' },
                        { t: 'Consulta nº CEF', s: 'Número da instituição financeira dos contratos' },
                        { t: 'Boleto Caixa', s: 'Emissão, anexo no CRM e envio ao cliente sem operador' },
                        { t: 'Fluxo de Pagamento', s: 'Esteira de lançamento automatizado no Sienge' },
                    ],
                },
                {
                    t: 'Ferramentas', s: 'Transversais, servem qualquer área', c: [
                        { t: 'Checklists', s: 'Substituiu o Planner e cobra sozinho' },
                        { t: 'Aprovações', s: 'Protocolo com decisão pelo WhatsApp e PDF de autorização' },
                        { t: 'Relatórios', s: 'Montados conversando com a Eme, link público ou privado' },
                        { t: 'Validador', s: 'Contratos e repasses analisados por IA, liberação automática no CRM' },
                        { t: 'Mural de Avisos', s: 'Comunicado com ciência registrada' },
                        { t: 'Alertas', s: 'Aviso automático por regra, com compartilhamento' },
                    ],
                },
                {
                    t: 'Central Microsoft', c: [
                        { t: 'Agenda e reuniões', s: 'Aviso 15 min antes, visão pensada para o celular' },
                        { t: 'Gravação, transcrição e ata', s: 'Resumo automático por IA' },
                        { t: 'SharePoint e Planner', s: 'Arquivos e quadros direto do sistema' },
                    ],
                },
                {
                    t: 'Academy', s: 'Base de conhecimento e trilhas', c: [
                        { t: 'Procedimentos', s: 'POPs do Comercial e do Sienge, tutoriais do CV em vídeo' },
                        { t: 'Trilhas de ensino', s: 'Gestores, administrativos e parceiros externos' },
                    ],
                },
                {
                    t: 'Eme, a IA da casa', s: 'Assistente em qualquer tela', c: [
                        { t: 'Responde com dado real', s: 'Todo número vem de consulta validada, nunca de memória' },
                        { t: 'Respeita alçadas', s: 'A IA só vê o que o usuário pode ver' },
                        { t: 'Relatórios por conversa', s: 'E resumo de reunião' },
                        { t: 'Independente de LLM', s: 'Roda sobre Gemini, OpenAI ou Anthropic' },
                    ],
                },
                {
                    t: 'Administração e acessos', c: [
                        { t: 'Usuários e Organograma', s: 'Entrada padronizada, aprovação de primeiro acesso' },
                        { t: 'Alçadas', s: 'Permissão por tela, empreendimento, cargo e departamento' },
                        { t: 'Backup do Sienge', s: 'Cópia diária restaurada automaticamente' },
                        { t: 'Integridade e integrações', s: 'Segurança das rotas verificada por rotina' },
                    ],
                },
            ],
        },
        {
            t: 'Integrações',
            s: 'O ecossistema em que o Office age',
            acc: MAP_ACCENTS.integracoes,
            c: [
                { t: 'Microsoft 365', s: 'Identidade única, Teams, agenda, SharePoint e Planner via Graph' },
                { t: 'Sienge (ERP)', s: 'API oficial e cópia diária do banco, somente leitura; escreve contratos e pagamentos' },
                { t: 'CV CRM', s: 'Lê leads, reservas e unidades; escreve e reconfere toda gravação' },
                { t: 'Meta e WhatsApp', s: 'Captação de leads e canal direto com botão de aprovação e PDF' },
                { t: 'Google Gemini', s: 'Sustenta a Eme, resumos e leitura de documentos, com rodízio de chaves' },
                { t: 'Supabase, DocuSign e Looqbox', s: 'Arquivos, assinatura eletrônica e alimentação do BI' },
            ],
        },
        {
        ...
        },
        {
            ...
            s: 'A ordem de grandeza do sistema e as regras da casa',
            acc: MAP_ACCENTS.tamanho,
            c: [
                {
                    t: 'Ordem de grandeza', c: [
                        { t: '~50 telas em produção', s: '8 categorias, 3 seções' },
                        { t: '34+ rotinas automáticas', s: 'Emitem boleto, liberam unidade, geram ficha, cobram tarefa' },
                        { t: '3 canais de notificação', s: 'No sistema, e-mail e WhatsApp corporativo' },
                        { t: '7 integrações externas', s: 'Node.js, Vue 3, Railway, Supabase e GitHub na base' },
                    ],
                },
                {
                    t: 'Princípios', c: [
                        { t: 'Nada de script manual', s: 'Toda mudança se aplica sozinha na publicação' },
                        { t: 'Regra no banco, não no código', s: 'VGV, comissão, tetos e IA editáveis por tela' },
                        { t: 'Toda tela ensina', s: 'Botão "Como usar" na linguagem do usuário' },
                        { t: 'Feito para o celular', s: 'A diretoria acessa exclusivamente pelo celular' },
                    ],
                },
                {
                    t: 'Segurança', c: [
                        { t: 'Acesso pela conta Microsoft', s: 'Desligou, o acesso morre junto; primeiro acesso em fila de aprovação' },
                        { t: 'Três camadas de permissão', s: 'Tela, empreendimento e decisão; a mesma regra fecha menu, API e IA' },
                        { t: 'Credenciais criptografadas', s: 'Webhook assinado, BI restrito à cópia do Sienge' },
                        { t: 'Links públicos controlados', s: 'Token, prazo, limite de uso e armadilha antirrobô' },
                        { t: 'Registro contínuo', s: 'Decisão com dono e data; varredura de rotas a cada subida' },
                    ],
                },
            ],
        },
...
export const officeHighlights = [
    ...
    { v: '~50', l: 'telas em produção', s: '8 módulos e 34+ rotinas automáticas' },
];
        ...
        blocks: [
            ...
            },
            {
                ...
                rows: [
                    ...
                    ['Backup do ERP', 'Cópia diária do Sienge restaurada automaticamente, sustentando os dados internos e o BI'],
                    ['Custo de obra', 'Planilha de controle enviada automaticamente ao Looqbox'],
                    ['Microsoft 365', 'Teams, SharePoint, Planner, agenda, reuniões, gravação, transcrição e ata gerada automaticamente'],
                    ...
                    ['Relatórios gerenciais', 'Montados conversando com a assistente; todo dado vindo de consulta pode gerar relatório, análise comparativa e link público ou privado'],
                    ['Validador', 'Análise de contratos e repasses por IA, com aprovação e liberação ou bloqueio automático no CRM'],
                    ['Academy', 'Base de conhecimento, procedimentos, treinamentos e trilhas para gestores, administrativos e parceiros externos'],
                    ['Assinatura eletrônica', 'DocuSign integrado para fichas e aprovações'],
                    ['Automação', 'Mais de 34 rotinas que emitem boleto, liberam unidade, geram ficha comercial, cobram tarefa e sincronizam dados sozinhas'],
                ],
            },
        ],
    },
    ...
    },
    {
        ...
        blocks: [
            ...
            },
            {
                ...
                result: 'O checklist substituiu o Planner e cobra sozinho. O pedido virou protocolo com decisão pelo WhatsApp e PDF de autorização. O comunicado obrigatório tem ciência registrada.',
        ...
        blocks: [
            ...
            },
            {
                ...
                rows: [
                    ...
                    ['Supabase', 'Armazenamento de arquivos: boletos, imagens de artigo e anexos', 'Storage público com limpeza automática'],
                ],
            },
            {
                type: 'table',
                caption: 'Ordem de grandeza.',
                head: ['Indicador', 'Situação atual'],
                rows: [
                    ['Telas em produção', 'Cerca de 50 itens de menu, em 8 categorias e 3 seções'],
                    ['Módulos de negócio', 'Comercial, Marketing, Financeiro, Ferramentas, Central Microsoft, Academy, Eme e Administração'],
                    ['Integrações externas', 'CV CRM, Sienge (API e backup), Meta, Microsoft 365, Google Gemini, DocuSign e Looqbox. Infraestrutura com Node.js, Vue 3, Railway, Supabase e GitHub'],
                    ['Canais de notificação', 'Interna no sistema, e-mail corporativo e WhatsApp corporativo'],
                ],
            },
            {
            ...
            { type: 'p', text: 'O Office lida com contrato, valor de venda, custo, dado de cliente e credencial de sistema externo. A segurança não é um módulo: é a estrutura que sustenta todos os outros.' },
            {
                type: 'list', caption: 'Segurança de dados e respaldo da empresa', items: [
                    'Quem entra: acesso pela conta Microsoft da empresa. Desligou, o acesso morre junto. Todo primeiro acesso nasce pendente em fila de aprovação, com permissões padrão do departamento aplicadas na ativação. Sessão de 8 horas com token rotacionado; reutilização de token antigo derruba todas as sessões da pessoa. Login e recuperação de senha com limite de tentativas.',
