<template>
    <div class="p-4 w-full min-h-[calc(100%-4rem)] relative overflow-x-hidden">
        ...
        <div class="mb-6 flex flex-wrap gap-4 items-center">
            ...
            <!-- <div class="flex items-center">
                <label class="ml-2 text-sm text-gray-700">Mostrar Todos</label>
                <Input v-model="mostrarTodos" type="checkbox" />  
            </div> -->
            <div>
                <Button @click="buscarLeads">Buscar Leads</Button>
            </div>
            <div>
        ...
        <div v-if="periodo.data_inicio && periodo.data_fim" class="mt-6 p-4 dark:bg-gray-700 rounded">
