<script setup>
// Gestão do mural: lista comunicados, cria/edita, publica, acompanha aderência,
// arquiva e exclui. É a ABA de gestão da tela /mural, não uma tela própria -
// quem administra o mural também recebe do mural, e eram duas telas com o mesmo
// nome no menu.
//
...
<template>
  <div>
    <!-- Barra da aba: filtro de status e a ação de criar. O botão morava no
         cabeçalho da tela; agora o cabeçalho é do mural inteiro, e criar
         comunicado é ação DESTA aba. -->
