...
const exemplos = computed(() => [
  ...
  { nome: 'E-mail (Outlook)', block: { id: 'g_email', kind: 'email', email: { to: [{ email: 'joao.silva@menin.com.br', name: 'João Silva' }], cc: [{ email: 'contato@sienge.com.br' }], subject: 'Ajuste na integração de clientes entre CV e Sienge', body: 'Olá, João.\n\nNotei que os clientes criados no CV chegam ao Sienge sem o índice da tabela de preços. Sugiro ajustarmos o CV para deixar o reajuste REAL como padrão, já que as séries seguem as regras contratuais.\n\nExiste algo na automação que possamos ajustar para evitar isso?\n\nAbraço,\nGustavo', note: 'Exemplo da galeria: enviar de verdade sai pela rota da tela de e-mail.' } } },
  { nome: 'E-mail · resposta', block: { id: 'g_email_reply', kind: 'email', email: { to: [{ email: 'julia.ramos@casaprime.com.br', name: 'Julia Ramos' }], subject: 'Re: Pasta 1.640 - documentação pendente', body: 'Oi, Julia.\n\nA certidão negativa já foi emitida hoje pela manhã e segue anexa no próximo e-mail. O restante está completo.\n\nObrigado!', replyTo: { messageId: 'demo', kind: 'reply', subject: 'Pasta 1.640 - documentação pendente', from: 'Julia Ramos', preview: 'Bom dia, Gustavo. Falta a certidão negativa do cliente para fecharmos a pasta 1.640...' } } } },
