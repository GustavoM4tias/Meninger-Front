        ...
        <template #actions>
          ...
          <PageHelp
            ...
            :steps="[
              ...
              { title: 'Parcelas: confira o que a rodada fez', text: 'O painel Acompanhamento lista boleto a boleto o que saiu no período - os mesmos “Emitido de/até” e “Pago de/até” da aba Histórico, com atalhos de hoje, 7 e 30 dias, e o valor emitido e pago ao lado da contagem: quem recebeu, por qual canal (anexo no CV, e-mail, WhatsApp) e, quando não saiu, o motivo escrito (CEP recusado pela Caixa, titular sem número no CV). Os selos do topo recortam a lista; clique na linha para abrir o boleto. Em Últimas rodadas fica o histórico de cada ciclo: quando rodou, quanto emitiu, o que falhou e onde caiu.' },
