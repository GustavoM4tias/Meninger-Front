        ...
        <template #actions>
          ...
          <PageHelp
            ...
            :tips="[
              ...
              'Parcela vencida: o cliente recebe um aviso de que a reserva pode ser cancelada, com um botão SIM para pedir a nova via. Respondeu SIM, o Office reemite na hora; a tela também tem o botão Reemitir. Sempre com o mesmo valor e vencimento no próximo dia útil. Nesta etapa não há multa nem juros. São duas vias novas por parcela (configurável): venceu a última, ou o aviso ficou 15 dias sem resposta, o cliente recebe o aviso final, sem nova via, com o número de contato, e a parcela fica em atraso para alguém decidir.',
