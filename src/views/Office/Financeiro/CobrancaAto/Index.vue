        ...
        <template #actions>
          ...
          <PageHelp
            ...
            :tips="[
              ...
              'O plano encerra sozinho por qualquer uma de duas regras: a venda foi faturada no Sienge (a mesma regra do relatório de Faturamento) ou o repasse no CV chegou a “Contrato Emitido CAIXA” ou a uma etapa seguinte (daí vêm a confissão de dívida, a assinatura e o faturamento). Nos dois casos os boletos em aberto do Office são baixados, para o cliente não pagar sem a informação para os contratos. As etapas do repasse que encerram são escolhidas em Configurações > Parcelas mensais.',
