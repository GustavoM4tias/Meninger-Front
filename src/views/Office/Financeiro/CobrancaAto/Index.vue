      ...
      <PageHeader
        ...
        <template #actions>
          ...
          <PageHelp
            ...
            :steps="[
              { title: 'Histórico: acompanhe as cobranças do ato', text: 'Lista o que foi emitido no período. O filtro tem dois períodos independentes: “Emitido de/até” e “Pago de/até”. Preencha só o de pagamento para ver o que entrou no período, venha de que emissão vier; os dois juntos respondem “do que saiu em agosto, o que foi pago em setembro”. Os cartões do topo contam quantos foram pagos, quantos ainda esperam e quantos falharam. Clique em um cartão para recortar a tabela (clicar de novo desfaz) e na linha para abrir o detalhe, com a linha do tempo e o PDF.' },
              ...
              { title: 'Parcelas: o que saiu e o que entrou', text: 'O filtro tem os mesmos “Emitido de/até” e “Pago de/até” da aba Histórico, com atalhos de hoje, 7 e 30 dias. Com período preenchido, a lista fica só com as reservas que tiveram boleto emitido ou parcela paga nele; a coluna “No período” e os cartões “Emitidas” e “Pagas” dizem quantos e quanto (sem período, valem 30 dias). Em Últimas rodadas, abaixo da lista, está o que cada ciclo fez e onde caiu. Os canais de envio e o motivo de cada boleto ficam no detalhe do plano.' },
