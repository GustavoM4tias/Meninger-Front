        ...
        <template #actions>
          <PageHelp
            ...
            :tips="[
              ...
              'O marcador âmbar são vendas distratadas depois. Com o interruptor em Com distratos elas contam no período (na época foram venda); em Sem distratos elas saem dos cartões, do ticket médio, das linhas, do detalhe e da planilha exportada, mas o marcador continua mostrando quantas são e quanto valem. O detalhe tem o mesmo interruptor, e trocar em um troca no outro. O fechamento mensal sempre congela com distratos.',
