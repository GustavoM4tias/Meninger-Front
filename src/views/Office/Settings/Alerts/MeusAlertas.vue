<script setup>
// "Meus alertas": as regras que a pessoa mandou a Eme vigiar. É a ABA de alertas
// da tela de Notificações - alerta é notificação que a própria pessoa programou,
// então escolher canal e escolher o que vigiar viraram a mesma tela.
//
// O cabeçalho e as abas ficam na casca (Notifications/Index.vue); aqui sobrou a
...
<template>
  <div>
  <!-- Ação da aba: criar alerta é conversa com a Eme, não formulário. -->
  <div class="flex items-center justify-end mb-4">
    <Button icon="fas fa-wand-magic-sparkles" size="sm" @click="openEmeForCreation">
      Criar via Eme
    </Button>
  </div>
